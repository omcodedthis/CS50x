...
// main takes in the user's text. It then finds the total letters, words & sentences in the text. It then determins the Coleman-Liau index,
// determining the grade. The grade is then printed.
int main(void)
{
